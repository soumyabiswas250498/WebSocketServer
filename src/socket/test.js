...
} from "../services/deviceServices.js";
...
const handleSocketConnection = (io) => {
  ...
  io.on("connection", (socket) => {
    ...
    socket.on("getOfflineMsg", () => {
      if (offlineMsg.length) {
        const toSocketId = deviceSocketMap[deviceId];
        console.log(toSocketId, deviceId, offlineMsg, "***t");
        io.to(toSocketId).emit("offlineMsg", offlineMsg);
